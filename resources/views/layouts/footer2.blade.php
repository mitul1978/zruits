<footer class="footer footer-light footer-zehna">
    <div class="footer-top p-5 my-5">
        <div class="container p-0">
            <div class="row">
                <div class="col-sm-6 d-flex align-items-center justify-content-sm-start justify-content-center mb-0 mb-sm-5">
                    <h6 class="mb-0" style="width: 360px">Sign Up for Our Newsletter</h6>
