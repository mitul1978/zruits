            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="mobile" class="col-form-label">Email</label>
                      <input id="mobile" type="number" min="0" name="mobile" placeholder="Enter your 10 digit mobile"  value="{{$profile->mobile}}" class="form-control">
                      @error('email')
                      <span class="text-danger">{{$message}}</span>
                      @enderror
                    </div>
