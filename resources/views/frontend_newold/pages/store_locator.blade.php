...
<div class="sidebar-contact">
   ...
   <p>Please fill your contact details, our executive will get in touch with you.</p>
   <form action="javascript:void(0)" class="store_enquiry" id="store_enquiry">
      <input type="hidden" id="catid" name="catid" value="">
      <div class="">
         <div class="col-lg-12 col-xs-12 p-lr-0">
            <div class="form-group">
               <input type="text" name="name" id="name1" class="form-control mt-2" placeholder="Name*">
            </div>
         </div>
         <div class="col-lg-12 col-xs-12 form-group p-lr-0">
   ...
   <div class="custom-container">
      ...
      <div class="col-md-12 store-locator-outer">
         <div class="col-md-5 store-locator-details">
            ...
            <h1 class="title-int-pages" style="margin-top: 50px;">Head Office :  </h1>
            <div class="head-office-block">
              <p class="add-head">
              6, Patel Avenue, First Floor, Near Gurudwara, S.G. Highway, Ahmedabad - 380054
            </p>
            <p><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:9586478629">+91- 9586478629</a></p>
            <p><i class="fa fa-envelope" aria-hidden="true"></i> <a href="mailto:customersupport@royaletouche.com" >customersupport@royaletouche.com</a></p>
            </div>
               ...
               if (req5.status == 200) {
                   ...
                   for (i = 0; i < locations.length; i++) {
                    var image = '{{asset("frontend/images/pin.png")}}';
                       ...
                       address_div += '<li><div class="flex-info-store"><div class="info">' + locations[i][0] + '</div><a href="https://royaletouche.com/store-detail/'+locations_temp[i].id+'" title="Click here for the details"><div class="show-map-icon"><i class="fa fa-info-circle" aria-hidden="true"></i></div></a></div></li>';
