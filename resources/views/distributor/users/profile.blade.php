...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('distributor.home')}}" style="color:#999">Dashboard</a></li>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if(@$profile->photo)
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="{{asset('images/distributors/'.$profile->photo)}}" alt="profile picture">
                        @else
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('distributor.profile-update',$profile->id)}}" enctype="multipart/form-data">
                    @csrf
