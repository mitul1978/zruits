<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{route('distributor.home')}}">
      <div class="sidebar-brand-icon ">
        <i class="fas fa-user-tie"></i>
      </div>
      <div class="sidebar-brand-text mx-3">Distibutor</div>
    </a>
    ...
    <!--Orders -->
    <li class="nav-item">
        <a class="nav-link" href="{{route('distributor.order.index')}}">
