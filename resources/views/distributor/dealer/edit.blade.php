...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('dealer.update',$user->id)}}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        <div class="row">
            <div class="col-md-4">
...
<div class="row">
    ...
    @if($user->photo)
    <img src="{{asset('images/dealers/'.$user->photo)}}" class="img-fluid rounded-circle" style="max-width:100px" alt="{{$user->photo}}">
@else
