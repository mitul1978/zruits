<style type="text/css">
    ...
    @if(!empty($colorpallets) && count($colorpallets) > 0)
    #colorpalletid.template2-bg{{count($colorpallets)}}{
        background: url(/frontend/images/pallete-icons/t2/bg/{{count($colorpallets)}}-palletbg.jpg);
        background-size: cover;
        background-repeat: no-repeat;
    }

    #colorpalletid.Pallete_Design_{{count($colorpallets)}}{
        background: url(/frontend/images/pallete-icons/t2/bg/{{count($colorpallets)}}-palletbg.jpg);
        background-size: cover;
        background-repeat: no-repeat;
    }
    @if(count($colorpallets) <= 7)
    .grid-container {
        display: grid;
        width: 60%!important;
        margin: 0px auto;
    ...
    */
    ...
    @if(!empty($colorpallets))

    <section class="product-visuals observable custom-gallery template2 @if(count($colorpallets) > 0) pallets_{{count($colorpallets)}} @endif">
       <div class="grid-container afterclass" id="light-gallery-memo-create">

         @foreach($colorpallets as $k=>$cp)
