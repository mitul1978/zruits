<style type="text/css">
    ...
    @if(!empty($color_palette->products) && count($color_palette->products) > 0)
    @if(count($color_palette->products) <= 7)
    .grid-container {
    display: grid;
    width: 60%!important;
    margin: 0px auto;
    ...
    @elseif(count($color_palette->products) == 8)
    .grid-container {
    display: grid;
    width: 75%!important;
    margin: 0px auto;
    ...
    @elseif(count($color_palette->products) == 9)
    .grid-container {
    display: grid;
    width: 75%!important;
    margin: 0px auto;
   ...
   /* position: absolute;
    ...
    @elseif(count($color_palette->products) == 10)
    .grid-container {
    display: grid;
    width: 75%!important;
    margin: 0px auto;
   ...
   /* position: absolute;
    ...
    @elseif(count($color_palette->products) == 11)
    .grid-container {
    display: grid;
    width: 75%!important;
    margin: 0px auto;
   ...
   /* position: absolute;
    ...
    @elseif(count($color_palette->products) == 12)
    .grid-container {
    display: grid;
    width: 80%!important;
    margin: 0px auto;
   ...
   /* position: absolute;
    ...
    /*13 PRODUCT*/
    @elseif(count($color_palette->products) == 13)
    .grid-container {
    display: grid;
    width: 75%!important;
    margin: 0px auto;
   ...
   /* position: absolute;
    ...
    #colorpalletid.Pallete_Design_{{count($color_palette->products)}}{
    background: url(/frontend/images/pallete-icons/t2/bg/{{count($color_palette->products)}}-palletbg.jpg);
    background-size: cover;
    background-repeat: no-repeat;
    }
 </style>
 @if(!empty($color_palette->products))
 <section class="product-visuals observable custom-gallery @if(count($color_palette->products) > 0) pallets_{{count($color_palette->products)}} @endif">
    <div class="grid-container afterclass" id="light-gallery-memo-create">
       @foreach($color_palette->products as $k=>$cp)
        @php
