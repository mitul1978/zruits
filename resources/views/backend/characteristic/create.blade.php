...
@section('title','ROYALE TOUCHE || Characteristic Create')
@section('main-content')

<div class="card">
    <h5 class="card-header">Add Characteristic</h5>
    <div class="card-body">
      <form method="post" action="{{route('characteristic.store')}}" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input id="inputTitle" type="text" name="content" placeholder="Enter Content"   class="form-control">
            @error('content')
            <span class="text-danger">{{$message}}</span>
            @enderror
            </div>
