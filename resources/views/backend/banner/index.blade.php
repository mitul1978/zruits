...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Banner List</h6>
                ...
                <tr>
                    ...
                    <td>
                      ...
                      <a target="_blank" href="{{ asset($banner->photo) }}">
                          <img src="{{ asset($banner->photo) }}" class="img-fluid" style=" max-height:100px" alt="{{$banner->photo}}">
                      </a>
                      @else
