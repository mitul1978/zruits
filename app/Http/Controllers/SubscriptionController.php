...
class SubscriptionController extends Controller
{
    ...
    {
        $subscribers=SubscribeNewsletter::paginate(50);
        // return $category;
        return view('backend.subscriptions.index')->with('subscribers',$subscribers);
    }
    ...
    {
        //$parent_cats=Contact::where('is_parent',1)->orderBy('title','ASC')->get();
