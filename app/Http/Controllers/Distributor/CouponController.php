...
class CouponController extends Controller
{
    ...
    public function index()
    {
        ...
        $coupon=Coupon::where('distributor_id',Auth::guard('distributor')->user()->id)->paginate('10');
        return view('distributor.coupon.index')->with('coupons',$coupon);
    }
    ...
    public function edit($id)
    {
        ...
        if($coupon){
            return view('distributor.coupon.edit',compact('dealers','coupon'));
        }
        else{
            return view('distributor.coupon.index')->with('error','Coupon not found');
        }
    }
