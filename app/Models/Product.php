...
class Product extends Model
{
    ...
    protected $fillable=['category_id','name','design','is_featured','is_new','is_bestsellers','price','stock_quantity','description','discount','slug','a4sheet_view','fullsheet_view','room_view','meta_title','meta_description','meta_image','meta_keyword','status','sort_order','tags'];
